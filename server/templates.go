...
import (
	"encoding/gob"
	"github.com/skinnyheat/aws-parameter-bulk/pkg/forms"
	"github.com/skinnyheat/aws-parameter-bulk/pkg/models"
	"github.com/skinnyheat/aws-parameter-bulk/ui"
	"html/template"
	"io/fs"
	"path/filepath"
)
...
func InitTemplates() {
	gob.RegisterName("github.com/skinnyheat/aws-parameter-bulk/server.templateData", &templateData{})
}
